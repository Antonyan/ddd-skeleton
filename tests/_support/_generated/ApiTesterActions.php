<?php  //[STAMP] ed463a8b57dc3d8d8ecf922e07ffb54a
...
trait ApiTesterActions
{
     ...
     *
     * @return string
     * @see \Helper\RandomGeneratorHelper::randomHash()
     */
    public function randomHash() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('randomHash', func_get_args()));
    }
     ...
     * @return int
     * @throws Exception
     * @see \Helper\RandomGeneratorHelper::randomId()
     */
    public function randomId() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('randomId', func_get_args()));
    }
     ...
     * @param $type
     * @return int|mixed
     * @see \Helper\RandomGeneratorHelper::increment()
     */
    public function increment($type) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('increment', func_get_args()));
    }
