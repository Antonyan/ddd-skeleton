...
$I->haveInDatabase('restaurantAttributeValues', ['id' => 120, 'restaurantId' => 130, 'value' => 'one']);

$I->setHeader('Content-type', 'application/json');
$I->sendPUT('restaurants/130', ['name' => 'updateRestaurant', 'attributes' => [['id' => 120, 'restaurantId' => 130, 'value' => 'two']]]);
